...
function Clear-StoreCache {
    Write-Step '[8/9] Microsoft Store 캐시 정리 중...'
...
function Ensure-MicrosoftStoreUpdated {
    Write-Step '[6/9] Microsoft Store 클라이언트 업데이트 확인 중...'
...
# ----------------------------------------------------------
Write-Step '[1/9] Windows Update 차단 정책 제거 중...'
...
# ----------------------------------------------------------
Write-Step '[2/9] 서비스 잠금(WubLock/ACL/svchost) 복구 중...'
...
# ----------------------------------------------------------
Write-Step '[3/9] Windows Update 작업 폴더 복구 중...'
...
# ----------------------------------------------------------
Write-Step '[4/9] Windows Update 관련 서비스 활성화 중...'
$services = @(
...
Write-Step '[5/9] Windows Update 검색 API 검증 중...'
...
# ----------------------------------------------------------
Write-Step '[7/9] 최신 루트 인증서 묶음 생성 중 (수십 초 소요될 수 있음)...'
...
# ----------------------------------------------------------
Write-Step '[9/9] 신뢰할 수 있는 루트 인증 기관에 임포트 중...'
if ($NoCertImport) {
...
# ----------------------------------------------------------
Write-Log '====================================================' ([ConsoleColor]::Cyan)
if ($script:RootImportOk -and $script:ServicesOk -and $script:WuSearchOk -and $script:StoreUpdateOk) {
